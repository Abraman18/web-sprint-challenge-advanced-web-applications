...
import mockArticleServiceCall from './../services/articleServices';
...
test("renders three articles without errors", async () => {
	mockArticleServiceCall.mockedResoledValueOnce(testData);
	render(<View />)
	
	await waitFor(() => {
		const articles = screen.queryAllByTestId('Article_Test');
